...
[
    [
        ["title"   => "Tramigo",
         ...
         "links"   => [["Visit website", "http://tomn.tramigoapp.com"], ["Download on the App Store", ""], ["Download on Google Play", ""], ["Download on the Windows Store", ""]]]
    ],
    ...
    [
        ["title"   => "Subtle Subtitles",
         ...
         "links"   => [["Download on the App Store", ""], ["View on GitHub", ""]]]
    ],
    ...
    [
        ["title"   => "Associations’ Portal",
         ...
         "links"   => [["Visit website", ""], ["View on GitHub", ""]]],
         
        ["title"   => "DigiSheep",
         "details" => "System to sell/buy tickets (including online), and then scan to grant access on-site.<br>Includes a website to manage data and check stats.<br>&nbsp;<br>Used to manage one event with 2,700 participants.",
         "imgs"    => ["img/projects/digisheep.png"],
         "links"   => [["Visit website", ""], ["Download on the App Store", ""], ["View on GitHub", ""]]]
    ],
    
    [
        ["title"   => "ESEOmega.fr",
         "details" => "Dynamic website for my Students’ Union.",
         "imgs"    => ["img/projects/eseomega.png"],
         "links"   => [["Visit website", ""]]],
         
        ["title"   => "Blue Moon 2016",
         "details" => "Website to promote and sell tickets for our event welcoming 2,700 students.",
    ...
    [
        ["title"   => "Campaign app",
         ...
         "links"   => [["View on GitHub", ""], ["Photograph © François Leparoux", "https://github.com/rascafr"]]],
    ...
    [
        ["title"   => "@tomn_ebooks",
         ...
         "links"   => [["View on Twitter", ""], ["View on GitHub", ""]]],
    ...
    [
        ...
        ["title"   => "Ball",
         "details" => "List of user-submitted songs in order to contribute to a Charity Dance.",
